// Orchestrator for `npm run setup`: brings up the local devnet services this
// network needs, compiles the contract, and deploys.
...
async function main(): Promise<void> {
  ...
  process.stdout.write(`\n→ Setting up HandMadeHub on network: ${network}\n\n`);
